...
object Dependencies {
    ...
    const val hilt_dagger_compiler =
        "com.google.dagger:hilt-android-compiler:${Versions.HILT_DAGGER_VERSION}"
    ...
    const val hilt_dagger_main =
        "com.google.dagger:hilt-android-gradle-plugin:${Versions.HILT_DAGGER_VERSION}"

    const val dagger = "com.google.dagger:dagger:${Versions.DAGGER_VERSION}"
    const val dagger_compiler =
        "com.google.dagger:dagger-compiler:${Versions.DAGGER_COMPILER_VERSION}"
